...
jupyter:
  ...
  kernelspec:
    ...
    name: julia-1.6
  plotly:
    description: How to make bubble maps in Juila with Plotly.
    display_as: maps
    language: juila
    layout: base
    name: Bubble Maps
    ...
    permalink: julia/bubble-maps/
    thumbnail: thumbnail/bubble-map.jpg
---

<!-- NOTE: Reference urls won't work -->

#### Base Map Configuration

Plotly figures made with `scattergeo` or `choropleth` functions have a `layout` object which can be used to [control the appearance of the base map](/julia/map-configuration/) onto which data is plotted.
...
trace = scattergeo(
    ...
    group=:continent,
    hover_name=:country,
    marker = attr(size=:pop, sizeref=maximum(df.pop), sizemode="area"),
    projection="natural earth"
)
